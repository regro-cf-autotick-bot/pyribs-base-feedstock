...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyribs-base-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12088&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyribs-base-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyribs-base` can be installed with:

```
conda install pyribs-base
```

It is possible to list all of the versions of `pyribs-base` available on your platform with:
